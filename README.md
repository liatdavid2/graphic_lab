...
26.5.22-27.5.22   14 hours of order all the files for submission . <br /><br/>
# Motivation
...
3. Deep learning - yolo5 video object detection model and vgg-16 CNN model that I trained.
# Project challenges
...
# Error handling
The app allert you with info and error message. one exemple of error and info handling <br/>
