...
10.5.22-12.5.22   22 hours of bulid client and server functionality - Delete all images not in class and Train, Validation, Test split and Image data augmentation.
19.5.22-19.5.22   16 hours of bulid client and server error handling.
25.5.22-26.5.22   14 hours of order all the files for submission .
# Motivation
